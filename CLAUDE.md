...
- **No vector database.** Retrieval over the 17 curated documents is rule-based keyword matching — deliberately chosen because the corpus is exact-match jargon (station names, pass names, regulation terms), not because of time pressure alone.
